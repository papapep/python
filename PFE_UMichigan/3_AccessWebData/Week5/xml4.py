...
We provide two files for this assignment. One is a sample file where we give you the sum for your testing and the other is the actual data you need to process for the assignment.
    ...
    Actual data: http://python-data.dr-chuck.net/comments_339403.xml (Sum ends with 38)
...
serviceurl = 'http://python-data.dr-chuck.net/comments_339403.xml'
uh = urllib.urlopen(serviceurl)

elements = ET.parse(uh)
suma = 0

for item in elements.getiterator():
    if item.tag=='count':
